...
//     fixture.simulateElectronOkResWithData(IpcChannel.GET_PARTIAL_RB, fakeRb);
...
//     fixture.simulateElectronOkResWithData(IpcChannel.IS_RB_READY, { ready: true });
...
//   cy.wait(100).then(() => {
//     fixture.simulateElectronOkResWithData(IpcChannel.GET_LOCK_INFO, {
...
//       expectAttachButtonIsOngoing();
//       assertLatestLogContent(LOG_TYPE.RB_ATTACH__START, { link }).then(() => {
//         fixture.simulateElectronOkResWithData(IpcChannel.GET_PARTIAL_RB, {
//           name: exceptionName,
...
//         fixture.simulateElectronOkResWithData(IpcChannel.IS_RB_READY, { name: exceptionName, message: exceptionMessage });
//         assertLatestLogContent(LOG_TYPE.EXCEPTION, { message: exceptionMessage });
...
//       clickCommitButton(link).then(() => {
//         fixture.simulateElectronOkResWithData(IpcChannel.IS_RB_READY, { ready: false, message: 'specific reason' });
...
//       fixture.simulateElectronOkResWithData(IpcChannel.GET_LOCK_INFO, { name: exceptionName, message: exceptionMessage });
//       assertLatestLogContent(LOG_TYPE.EXCEPTION, { message: exceptionMessage });
//       actionCellShouldBackToNormal();
//     });
...
//       fixture.simulateElectronOkResWithData(IpcChannel.GET_LOCK_INFO, lockInfo);
...
//       const exceptionMessage = 'some external reason';
//       fixture.simulateElectronOkResWithData(IpcChannel.SVN_COMMIT, { name: exceptionName, message: exceptionMessage });
//       assertLatestLogContent(LOG_TYPE.EXCEPTION, { message: exceptionMessage });
//       actionCellShouldBackToNormal();
//     });
//     it('Case2: should be failed if commit message is invalid then exit the process', () => {
//       fixture.simulateElectronOkResWithData(IpcChannel.SVN_COMMIT, { message: 'specific reason' });
...
//       fixture.simulateElectronOkResWithData(IpcChannel.SVN_COMMIT, { revision });
